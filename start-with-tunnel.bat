...
echo [INFO] Verificando se o servidor esta respondendo...
...
if "%tunnel_option%"=="1" (
    ...
    echo [INFO] URL sera exibida abaixo quando o tunnel estiver pronto.
    echo.
    cloudflared tunnel --url http://%TUNNEL_HOST%:%TUNNEL_PORT% --hostname %tunnel_hostname%
) else (
    ...
    echo ========================================
    echo.
    cloudflared tunnel --url http://%TUNNEL_HOST%:%TUNNEL_PORT%
)
